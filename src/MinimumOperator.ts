...
/**
 * Minimum of two bounded numbers.
 */
export class MinimumOperator extends SWOperator {
    constructor(in_left: any = 0, in_right: any = 0) {
        super();
        this.operator_type = "Minimum";
    ...
    public override data_to_string(): string {
        return `Min(${this.stringify_operand_at_index(0)}, ${this.stringify_operand_at_index(1)})`;
    }
}
