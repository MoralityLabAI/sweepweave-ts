...
/**
 * Average of two bounded numbers.
 */
export class AverageOperator extends SWOperator {
    constructor(in_left: any = 0, in_right: any = 0) {
        super();
        this.operator_type = "Average";
    ...
    public override data_to_string(): string {
        return `Average(${this.stringify_operand_at_index(0)}, ${this.stringify_operand_at_index(1)})`;
    }
}
